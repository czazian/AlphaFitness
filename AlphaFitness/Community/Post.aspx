        ...
        <div class="outer">
            ...
            <div class="post">
                ...
                <div class="middle-community" style="width: 100%;">
                    ...
                    <!--One comment-->
                    <asp:Repeater EnableViewState="false" runat="server" ID="commentRepeater" OnItemDataBound="commentRepeater_ItemDataBound">
                        <ItemTemplate>
                                ...
                                <div class="commenter-container">
                                    <div class="commenter-detail">
                                        <div class="infobar-comment">
                                            ...
                                            <div class="title-obtain">
                                                <asp:Image runat="server" ID="imgCmt" CssClass="titleImg" ImageUrl='<%# Eval("EquippedImageUrl") %>' />
                                            </div>
                                        </div>

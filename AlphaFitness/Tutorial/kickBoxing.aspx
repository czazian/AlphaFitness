<%@ Page Title="" Language="C#" MasterPageFile="~/Contents.Master" AutoEventWireup="true" CodeFile="kickBoxing.aspx.cs" Inherits="AlphaFitness.Tutorial.kickBoxing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 id="header">Kick Boxing</h1>
    <div class="intro-box">
        <h6>Increase your strength and conditioning and build lean muscle with this boxing workout.</h6>
    </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Contents.Master" AutoEventWireup="true" CodeFile="dumbbell.aspx.cs" Inherits="AlphaFitness.Tutorial.dumbbell" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 id="header">Dumbbell</h1>
        <div class="intro-box">
            <h6>Create new and massively sculpted set of pipes now with these easy to use armday hacks.</h6>
        </div>

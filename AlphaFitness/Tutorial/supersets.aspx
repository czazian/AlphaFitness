<%@ Page Title="" Language="C#" MasterPageFile="~/Contents.Master" AutoEventWireup="true" CodeFile="supersets.aspx.cs" Inherits="AlphaFitness.Tutorial.supersets" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 id="header">Supersets</h1>
    <div class="intro-box">
        <h6>A superset is performing a set of two different exercises back-to-back with little rest in between. These can help boost the aerobic intensity of your weight-lifting and reduce the time you need for each workout.</h6>
    </div>

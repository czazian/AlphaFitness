<%@ Page Title="" Language="C#" MasterPageFile="~/Contents.Master" AutoEventWireup="true" CodeFile="yogaStretching.aspx.cs" Inherits="AlphaFitness.Tutorial.yoga_Stretching" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 id="header">Yoga & Stretching</h1>
    <div class="intro-box">
        <h6>Yoga is a physical and mental practice that brings the mind and body together—while simultaneously focusing on your breathing and bringing awareness to your body to stay present, centered, and focused. Stretching is a physical exercise that is less about mindfulness and more about the physical benefits it can provide.</h6>
    </div>
        <div class="subtitle-link">
            <a href="#tips-category" id="tips-category">TIPS</a>
            <a href="#articles-category">ARTICLES</a>
            <a href="#sbsguide-category">STEP-BY-STEP GUIDE</a>
            <a href="#exercisev-category">EXERCISE VIDEOS</a>
        </div>

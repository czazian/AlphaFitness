<%@ Page Title="" Language="C#" MasterPageFile="~/Contents.Master" AutoEventWireup="true" CodeFile="functionalTraining.aspx.cs" Inherits="AlphaFitness.Tutorial.functionalTraining" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="home-content">
        <h1 id="header">Functional Training</h1>
        <div class="intro-box">
            <h6>Functional exercises teach your body to work as a whole rather than training specific parts. Strengthening the whole body in this way has many benefits for your health. Daily life. Functional training trains the same muscle movements you use in everyday life.</h6>
        </div>
